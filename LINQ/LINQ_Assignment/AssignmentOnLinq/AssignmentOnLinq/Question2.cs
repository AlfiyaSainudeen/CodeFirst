...
{
    //. Given a list of participants for a tennis match. Split the list into 2 equal halves and display
    //all the possible combination of matches possible between the participants in the two lists.
